...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error || err.response?.data?.detail || err.message || t('loginFailed') || 'Login failed. Please try again.'
      ...
      <div className="flex min-h-screen">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            {t('loginToAccount') || 'Login to your account to continue'}
          </p>
        </div>
